    ...
    def draw(self, canvas):
        if self.animated:
            canvas.draw_image(self.image,
                              [self.image_center[0] + ((self.age % 5) * self.image_size[0]),
                               self.image_center[1] + ((self.age / 5) * self.image_size[1])],
